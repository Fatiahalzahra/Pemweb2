...
<form>
  <div class="form-group row">
    <label for="Masukkan Nama Customer " class="col-4 col-form-label">Customer</label> 
    <div class="col-8">
      <input id="Masukkan Nama Customer " name="Masukkan Nama Customer " type="text" class="form-control">
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="Jumlah " name="Jumlah " placeholder="Jumlah Pemilihan " type="text" class="form-control">
    </div>
  </div> 
  <div class="form-group row m-3">
    ...
    <div class="col-4">
        <ul class="list-group">
            ...
            <li class="list-group-item active">Daftar Harga Dapat Setiap Saat </li>
        </ul>
    </div>
